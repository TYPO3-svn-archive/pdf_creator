...
var pdfPage = {
  ...
  height: 11.69, // inches
  margins: {
    top: 0.708661, left: 0.590551, 
    right: 0.590551, bottom: 0.787402 
  }
};
 ...
 * @type {String} toSplit
 */
var splitClassName = 'csc-default';
  ...
  while (tablesModified) {
    ...
    $('table.'+splitClassName).each(function(){
      ...
      $('tbody tr', $t).each(function(){
        ...
        //$tr.find('td:first').html(ctop+' pe: '+splitThreshold+' trh: '+ trHeight);
      ...
      $br.insertAfter($t);
      copy.insertAfter($br);
      //$cbody.prepend('<tr><th><!--Bild--></th><th colspan="3" width="100%"><!--Aufgaben--></th></tr>');
    });
  }
